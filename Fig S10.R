...
###Plot###
dpi=600
tiff("Fig S10A.tif", width=5*dpi, height=5*dpi, res=dpi)
...
############################FIGURE S10B: 16S DMM ALPHA DIVERSITY############################
...
############################FIGURE S10C: 16S DMM TAXA BARPLOT############################
...
###Plot PCoA###
dpi=600
tiff("Fig S10D.tif", width=5*dpi, height=5*dpi, res=dpi)
plot(c(-0.6, 0.4), c(-0.4, 0.5), font = 2, font.lab = 2, xlab="PC1", ylab="PC2", type="n")
...
############################FIGURE S10E: 16S PPRD DMM ALPHA DIVERSITY############################
...
############################FIGURE S10F: 16S PPRD DMM TAXA BARPLOT############################
...
###Plot###
dpi=600
tiff("Fig S10G.tif", width=5*dpi, height=5*dpi, res=dpi)
...
############################FIGURE S10H: 16S BPD DMM ALPHA DIVERSITY############################
...
############################FIGURE S10I: 16S BPD DMM TAXA BARPLOT############################
