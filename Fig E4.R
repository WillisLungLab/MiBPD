...
############################FIGURE E4B: SAAB MULTIKINGDOM ALPHA DIVERSITY############################
...
############################FIGURE E4D: SAAB MULTIKINGDOM BETA DIVERSITY PCoA############################
...
#Plot!
dpi=600
tiff("Beta Diversity Multikingdom PCoA SAAB.tif", width=5*dpi, height=5*dpi, res=dpi)
...
############################FIGURE E4E: SAAB MULTIKINGDOM DESeq2 ASV Boxplot############################
...
############################FIGURE E4F: SAAB MULTIKINGDOM DESeq2 Plot############################
